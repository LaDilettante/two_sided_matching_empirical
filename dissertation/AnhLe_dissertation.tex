...
%-----------------------------------------------------------------------------%
\author{Anh Le}
\title{Estimating the Preference of Countries and Multinational Corporations Using Two-Sided Matching Model}
...
%-----------------------------------------------------------------------------%
\dedication{For my wife and my parents.}
...
\include{three_issues}
\include{two_sided_matching}
\include{simulation}
%\include{labor}
\include{fdi}
%\include{chRegularLook}
\include{conclusion}
%==============================================================================
...
%-----------------------------------------------------------------------------%
\appendix
\include{MH_ratio} % Start with '\chapter{Title}'
\include{appendix_FDI_terms}
\include{appendix_traceplot}
