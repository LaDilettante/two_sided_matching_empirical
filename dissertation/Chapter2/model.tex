...
The term $b_j$ is absorbed into $\bm{\beta}$ when we add an intercept term to the covariate matrix $X$.
...
where $a_i$ is the index of the firm that $i$ accepts to to work for. Unemployment
is indexed as 0.
